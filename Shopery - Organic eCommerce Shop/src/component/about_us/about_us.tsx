    ...
    <section className="mt-[80px]">
      <div className="mb-[80px] flex items-center justify-center space-x-[28px]">
        <div className="flex flex-col">
          <h1 className="mb-8 text-Heading01 font-semibold text-gray-900">
        ...
        <img src="/img/aboutus/aboutus1.png" alt="" />
      </div>

      <div className="flex items-center">
        <img src="/img/aboutus/aboutus2.png" className="-ml-[300px]" alt="" />
        <div className="-ml-[100px]">
          <h1 className="mb-5 w-full text-Heading01 font-semibold text-gray-900">
            100% Trusted Organic Food Store
          </h1>
      ...
      <section className="mt-[80px] flex items-center">
        <div className="w-[40%]">
          <h1 className="mb-6 text-Heading02 font-semibold text-gray-900">
            We Delivered, You <br /> Enjoy Your Order.
          </h1>
          <p className="mb-5 text-BodyMedium font-regular text-gray-600">
          ...
          <CheckboxRes className="mb-4" label="Sed in metus pellentesque." />
          <CheckboxRes
            className="mb-4"
        ...
        <img src="/img/aboutus/aboutus3.png" className="-mr-[200px]" alt="" />
      </section>

      <section className="mt-[80px] text-center">
        <h1 className="text-Heading02 font-semibold text-gray-900">
          Our Awesome Team
        </h1>
