...
const Cart: React.FC<ShoppingcardProps>=({onClose}) => {
  ...
  return (
    <div className="fixed right-0 top-0 h-[100vh] w-[400px] bg-white shadow-lg p-4 z-30 max-md:w-[375px] max-sm:h-[600px]">
    ...
    <div className="space-y-4 h-[75%] overflow-y-auto scrollbar scrollbar-thumb-green-300 scrollbar-track-HardPrimary max-sm:h-[55%]">
